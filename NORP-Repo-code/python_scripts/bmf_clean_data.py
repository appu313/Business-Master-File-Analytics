...
def main():
    ...
    parser.add_argument('--input', '-i', 
                       default='Data/BMF_UNIFIED_sample.csv',
...
if __name__ == "__main__":
    ...
    input_filename = os.path.join(current_directory, '..', 'data', 'BMF_UNIFIED_V1.1')
    output_filename = os.path.join(current_directory, '..', 'data', 'BMF_UNIFIED_V1.1_cleaned.csv')
    clean_bmf_data(input_filename, output_filename)
    # main()
